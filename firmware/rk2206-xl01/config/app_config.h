...
#define TELEMETRY_PAYLOAD_FORMAT_COMPACT_V6 6
// Layered 46-byte scopes: P1/P2 core, P3 environment, P4 RTK/RTCM audit.
#define TELEMETRY_PAYLOAD_FORMAT TELEMETRY_PAYLOAD_FORMAT_COMPACT_V6
...
// Version marker
#define FIRMWARE_SAMPLE_VERSION "v1.6-um220-rs485-rtk-compact-v6-gps-uart-drain"
...
#define GNSS_RTCM_CAPABILITY_MARKER "boot=DISABLED capability=DISABLED"
#elif GNSS_RTCM_INJECTION_CAPABILITY == GNSS_RTCM_INJECTION_PROBE
#define GNSS_RTCM_CAPABILITY_MARKER "boot=DISABLED capability=PROBE"
#elif GNSS_RTCM_INJECTION_CAPABILITY == GNSS_RTCM_INJECTION_LIVE
#define GNSS_RTCM_CAPABILITY_MARKER "boot=DISABLED capability=LIVE"
#else
#error "Unsupported GNSS_RTCM_INJECTION_CAPABILITY"
#endif
