/*
 * Deprecated GPS module implementation.
 *
 * This file is not part of BUILD.gn and must not be used as the active GPS
 * implementation for the current hardware stable version.
 * The active implementation is gps_driver.c.
 */
