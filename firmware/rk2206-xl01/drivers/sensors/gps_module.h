/*
 * Deprecated GPS module header.
 *
 * This file is kept only as a historical reference and must not be treated as
 * the active GPS implementation. The current source of truth is gps_driver.*.
 * Current UART truth has already been frozen elsewhere; do not use this file
 * to infer active pin assignments.
 */
