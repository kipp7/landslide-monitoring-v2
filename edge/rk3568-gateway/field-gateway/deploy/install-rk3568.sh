...
SOUTHBOUND_POLLING_SESSION_TIMEOUT_MS="${SOUTHBOUND_POLLING_SESSION_TIMEOUT_MS:-6500}"
...
SOUTHBOUND_LAYERED_ENVIRONMENT_EVERY_ROUNDS="${SOUTHBOUND_LAYERED_ENVIRONMENT_EVERY_ROUNDS:-30}"
SOUTHBOUND_LAYERED_AUDIT_EVERY_ROUNDS="${SOUTHBOUND_LAYERED_AUDIT_EVERY_ROUNDS:-60}"
BUILD_FIRST=1
ENABLE_NOW=1
OVERWRITE_ENV=0
...
SOUTHBOUND_POLLING_RETRY_AFTER_MS=1500
