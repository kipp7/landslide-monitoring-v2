...
import { RealtimeAnomalyTable, type RealtimeAnomalyEvent } from '../analysis/components/RealtimeAnomalyTable'
import { RealtimeSensorStatusTable, type RealtimeDeviceLastSeen } from '../analysis/components/RealtimeSensorStatusTable'
import type { StationMapPoint, StationMapTile } from '../analysis/components/StationMap'

const StationMap = dynamic(() => import('../analysis/components/StationMap'), { ssr: false })
const AnalysisAiPanel = dynamic(() => import('../analysis/components/AnalysisAiPanel'), { ssr: false })
