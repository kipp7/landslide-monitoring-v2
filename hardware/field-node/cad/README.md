...
Status: `CAD-R0.1 / REFERENCE ONLY / NOT FOR MANUFACTURE`
...
`models/CAD-R0.1/` contains independent reference parts:
...
- `FN-SUB-001`: 120 x 85 x 3 mm 304 tilt reference plate with the verified
  78 x 39 mm transmitter hole pattern.
