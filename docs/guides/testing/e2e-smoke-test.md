...
阶段 2（可告警闭环回归基线，一键跑完阶段 1 基线 + alerts，推荐作为规则/告警改动后的快速验收）：

- `powershell -NoProfile -ExecutionPolicy Bypass -File infra/compose/scripts/e2e-smoke-test.ps1 -Stage2Regression`
