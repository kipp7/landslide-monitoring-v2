...
| WS-N.8 | codex | `feat/ws-n8/analysis-3d-map` |  | claimed | WS-N.5 | Web：`/analysis` 3D 地图 1:1：移植 `Map3DContainer`（或等价 3D 引擎），补齐参考区 2D/3D/卫星/视频切换与交互；如 3D 依赖新引擎，先拆“技术选型+最小 demo”PR |
