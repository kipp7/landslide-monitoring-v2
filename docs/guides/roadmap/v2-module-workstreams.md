...
| WS-O.6 | codex | `fix/ws-o6/device-management-page-backup-file` |  | in_progress | WS-O.4 | Web：补齐参考区遗留文件 `frontend/app/device-management/page.tsx.backup` 在 v2 的对应落点（仅文件不缺失；不参与运行时路由）。 |
