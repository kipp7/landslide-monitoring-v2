...
| WS-D.3 | codex | `feat/ws-d/baseline-management-ui` | https://github.com/kipp7/landslide-monitoring-v2/pull/105 | in_review | WS-D.1 | Web: 基准点管理页（`/device-management/baselines`）对接 `/api/v1/gps/baselines/*` |
