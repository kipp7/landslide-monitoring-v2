...
| WS-F | codex | `feat/ws-f/huawei-iot-adapter` | https://github.com/kipp7/landslide-monitoring-v2/pull/99 | in_review |  | IoT adapter: Huawei IoT HTTP push -> Kafka telemetry (no UI) |
