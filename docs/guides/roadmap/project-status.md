...
- 2025-12-25：运行大屏设备影子/风险等级 1:1（WS-N.13）：Web `/analysis` 实现 legacy `useDeviceShadow`，从 v2 `/api/v1/data/state` 获取主设备状态并计算 `risk_level`（时效/阈值规则），驱动红色告警光效与 LiquidFillChart。
