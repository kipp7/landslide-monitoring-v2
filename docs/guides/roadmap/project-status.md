...
- 2025-12-26: fix(api): `/api/device-management-real(-db)` supports `mode=all|summary|device_specific` (summary/device_specific are adapted from existing v2 legacy endpoints).
- `npm run lint`
- `npm run build`
