...
最后更新时间：2025-12-26（WS-K.18：iot-server /devices 兼容；WS-K.17：legacy camera alias；WS-K.16：legacy baselines alias routes；WS-K.15：legacy compat aliases 补齐；WS-N.20：/analysis legacy 占位组件还原）
