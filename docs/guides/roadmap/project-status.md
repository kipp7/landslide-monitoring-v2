...
最后更新时间：2025-12-20（已开始阶段 4：补齐 /system/status + /dashboard，并落地阶段 4 验收清单）
...
1) ✅ Stage 4 验收清单：`docs/guides/roadmap/stage4-acceptance.md`（后续按清单逐项完成与验收）
2) App/Web 依赖接口：继续补齐并固化 App/Web 依赖的“字典 + DTO”接口与 OpenAPI（避免前端写死映射/阈值）
