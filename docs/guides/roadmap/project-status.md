...
- 2025-12-26: fix(api): legacy `/api/ai-prediction` accepts both `sensorData` and `sensor_data` (array or single object), matching reference Next route payload variations.
- `npm run lint`
- `npm run build`
