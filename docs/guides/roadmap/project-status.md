...
- 2025-12-24：Legacy GPS baselines 兼容：新增 `GET/GET{deviceId}/POST/PUT/DELETE /api/baselines*`（对齐参考区 baseline-management-api 的基准点列表/查询/手动设置/删除端点；映射到 v2 `gps_baselines` 表与 baseline JSON）。
