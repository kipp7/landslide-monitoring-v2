...
const VALIDATION_SAMPLES =
  ".tmp/regional-model-library/out/artifacts/badong-huangtupo-context-enriched-v5/badong-huangtupo-core.validation.context-enriched-v5.jsonl";
const OUT_REPORT = path.join(REGISTRY_ROOT, "check-badong-huangtupo-v5-runtime-validation.report.json");
...
async function main() {
  ...
  const report = {
    ...
    productionDecision: artifact.metadata?.promotionDecision ?? null,
    promotionBlockedBy: artifact.metadata?.promotionBlockedBy ?? null,
