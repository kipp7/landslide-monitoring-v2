...
const OUT_REPORT = path.join(REGISTRY_ROOT, "check-badong-huangtupo-v7-runtime-validation.report.json");
...
async function main() {
  ...
  const report = {
    ...
    productionDecision: artifact.metadata?.supportGuard?.promoteAllowed === true ? "promoted-candidate" : null,
