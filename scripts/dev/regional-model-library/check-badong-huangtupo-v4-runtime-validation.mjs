...
const VALIDATION_SAMPLES =
  ".tmp/regional-model-library/out/artifacts/badong-huangtupo-hgb-support-guarded-production-v4/badong-huangtupo-core.validation.runtime-window-features.jsonl";
const OUT_REPORT = path.join(REGISTRY_ROOT, "check-badong-huangtupo-v4-runtime-validation.report.json");
