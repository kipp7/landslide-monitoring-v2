...
$reportFile = Join-Path $repoRoot "docs/unified/reports/desk-win-installer-latest.json"
...
$selfContainedManifest = Get-Content -Path (Join-Path $repoRoot "docs/unified/reports/desk-win-selfcontained-package-latest.json") -Raw -Encoding UTF8 | ConvertFrom-Json
