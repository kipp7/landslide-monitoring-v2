...
param(
  ...
  [string]$ReleaseDirectory = "F:\2\openharmony\rk2206_firmware_releases\xls1_compact_v6_protected_p1_rs485_gnss_simulated_20260804",
...
$expectedFirmwareMarker = "fw-rk2206-rtk-compact-v6-layered-v3-protected-p1-20260804"
...
Truth profile
  ...
  - Protection: duplicate P1 suppression depth 256; no production P2 retries
...
After all nodes are online, run the repository script on RK3568:
  ...
  sudo python3 scripts/field/xls1_compact_v6_layered_acceptance.py --core-mode broadcast --core-response-timeout-ms 6500 --extension-response-timeout-ms 6000 --environment-every-rounds 30 --audit-every-rounds 60 --max-p95-interval-ms 2500 --max-p95-command-latency-ms 2500 --max-command-latency-ms 6500 --required-gnss-source simulated
