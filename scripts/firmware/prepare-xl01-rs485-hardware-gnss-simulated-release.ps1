...
param(
  ...
  [string]$ReleaseDirectory = "F:\2\openharmony\rk2206_firmware_releases\xls1_compact_v4_rs485_diag_v5_r4_gnss_simulated_20260804",
...
$expectedFirmwareMarker = "fw-rk2206-rtk-compact-v4-rs485-diag-v5-r4-20260804"
