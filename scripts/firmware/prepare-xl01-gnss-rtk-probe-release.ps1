...
param(
  ...
  [string]$ReleaseDirectory = "F:\2\openharmony\rk2206_firmware_releases\xl01_gnss_rtk_v31_probe_sensor_diag_v4_20260729",
...
try {
  ...
  $releaseManifest = [ordered]@{
    schemaVersion = 1
    profile = "rk2206-xl01-gnss-rtk-v31-probe-sensor-diag-v4"
...
- Report PROBE V4 diagnostics for U4 I2C address, both SC16IS752 UARTs,
  categorized Modbus failures and one bounded read-only parameter scan.
- Preserve the V1/V2/V3 response prefix and normal compact telemetry format.
- Restore 1.8432 MHz / 4800 baud production UART settings after the scan.
